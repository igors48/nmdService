...
public class FeedReadReport {
    ...
    public FeedReadReport(final UUID feedId, final String feedLink, final String feedTitle, final int read, final int notRead, final String topItemId, final String topItemLink) {
