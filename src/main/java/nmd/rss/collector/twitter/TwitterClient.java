...
public class TwitterClient {
    ...
    public List<Tweet> fetchTweets(final String screenName, final int count) throws IOException {
        ...
        return fetchTweets(accessToken, screenName, count);
    }

    private static List<Tweet> fetchTweets(final AccessToken accessToken, final String screenName, final int count) throws IOException {
    ...
    private AccessToken getAccessToken() throws IOException {
        ...
        try {
            final String apiKeyEncoded = URLEncoder.encode(this.apiKey, UTF_8);
            final String apiSecretEncoded = URLEncoder.encode(this.apiSecret, UTF_8);
    ...
    //TODO move to utils or its exists
